...
document.getElementById("update_emoji").innerHTML="&#128526";
    }
    if ( results[0].label=="trizte"){
        document.getElementById("update_emoji").innerHTML="&#128557";
            }
            if ( results[0].label=="emocionado"){
                document.getElementById("update_emoji").innerHTML="&#128561	";
                    }
                    if ( results[1].label=="feliz"){
                        document.getElementById("update_emoji2").innerHTML="&#128526";
                            }
                            if ( results[1].label=="trizte"){
                                document.getElementById("update_emoji2").innerHTML="&#128557";
                                    }
                                    if ( results[1].label=="emocionado"){
                                        document.getElementById("update_emoji2").innerHTML="&#128561";
                                            }
}}
